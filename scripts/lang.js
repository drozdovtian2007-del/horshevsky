(() => {
  const translations = {
    ru: {
      ...
      about_tg_label:  'Готов обсудить ваш проект',
      about_tg_sub:    'Напишите напрямую в Telegram или отсканируйте QR-код',
      about_tg_btn:    '@UNPOORABLE',
      about_tg_scan:   'сканировать для связи',
      ...
      contact_qr_btn:  'Показать QR',
      qr_modal_title:  'Отсканируйте код',
      qr_modal_sub:    'Откроется чат в Telegram',
    ...
    en: {
      ...
      about_tg_label:  'Ready to discuss your project',
      about_tg_sub:    'Message me directly on Telegram or scan the QR code',
      about_tg_btn:    '@UNPOORABLE',
      about_tg_scan:   'scan to connect',
      ...
      contact_qr_btn:  'Show QR',
      qr_modal_title:  'Scan the code',
      qr_modal_sub:    'Opens Telegram chat',
